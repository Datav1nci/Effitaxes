...
export const dictionary = {
    fr: {
        ...
        auth: {
            ...
            sessionExpiredInactivity: "Session expirée en raison d'inactivité. Veuillez vous reconnecter.",
            passwordUpdated: "Mot de passe mis à jour avec succès. Veuillez vous connecter.",
            accountLocked: "Compte verrouillé. Contactez le 450-259-1829 ou réinitialisez votre mot de passe.",
            emailRequired: "L'adresse courriel est requise.",
            couldNotSendResetLink: "Impossible d'envoyer le lien. Veuillez réessayer.",
            sessionExpiredReset: "Session expirée. Veuillez demander un nouveau lien de réinitialisation.",
            failedUpdatePassword: "Échec de la mise à jour du mot de passe.",
            resetLinkInvalid: "Le lien est invalide ou expiré. Veuillez en demander un nouveau.",
            emailVerificationFailed: "La vérification du courriel a échoué. Veuillez vous réinscrire ou contacter le support.",
            verificationLinkInvalid: "Le lien de vérification est invalide ou expiré. Veuillez réessayer.",
            noResetCode: "Aucun code trouvé. Veuillez demander un nouveau lien de réinitialisation.",
            requestNewResetLink: "Demander un nouveau lien",
            verifyingResetLink: "Vérification du lien…",
            passwordUpdatedRedirecting: "Mot de passe mis à jour ! Redirection vers la connexion…",
        ...
        enrollment: {
            ...
            personal: {
                ...
                incomeSource: "Métier / Occupation",
                ...
                household: {
                    title: "Membres du foyer fiscal",
                    subtitle: "Ajoutez votre conjoint(e), enfants et autres personnes à charge.",
                    ...
                    isDependent: "Personne à charge",
                    livesWithPrimary: "Vit avec le déclarant principal",
                    relationships: {
                        SPOUSE: "Conjoint(e)",
            ...
            rental: {
                ...
                removeProperty: "Retirer la propriété",
        ...
        documents: {
            title: "Mes Documents",
            subtitle: "Téléversez vos feuillets fiscaux, reçus et autres pièces justificatives.",
            enrollmentSubtitle: "Téléversez vos feuillets (T4, T5, reçus, etc.) maintenant ou plus tard depuis votre tableau de bord. Cette étape est optionnelle.",
            uploadBtn: "Téléverser des fichiers",
            dragDrop: "Glissez-déposez vos fichiers ici, ou cliquez pour parcourir",
            labelPlaceholder: "Description (ex: T4 de l'employeur)",
            labelLabel: "Description (optionnel)",
            errorSize: "Ce fichier dépasse la limite de 15 Mo.",
            errorType: "Type de fichier non accepté. PDF, JPEG, PNG, HEIC, Excel ou CSV seulement.",
            errorUpload: "Erreur lors du téléversement. Veuillez réessayer.",
            successUpload: "Fichier(s) téléversé(s) avec succès !",
            noDocuments: "Aucun document téléversé pour le moment.",
            uploadedAt: "Envoyé le",
            maxFiles: "Maximum 10 fichiers par envoi.",
            uploading: "Téléversement en cours…",
            deleteConfirm: "Supprimer ce document ?",
            deleteBtn: "Supprimer",
            notifyAdmin: "L'administrateur sera notifié de vos nouveaux documents.",
            selectedFiles: "fichier(s) sélectionné(s)",
            submitUpload: "Envoyer les fichiers",
            remove: "Retirer",
            optional: "Cette étape est optionnelle — vous pouvez téléverser vos documents à tout moment depuis votre tableau de bord.",
    ...
    en: {
        ...
        auth: {
            ...
            sessionExpiredInactivity: "Session expired due to inactivity. Please sign in again.",
            passwordUpdated: "Password updated successfully. Please sign in.",
            accountLocked: "Account locked. Contact 450-259-1829 or reset your password.",
            emailRequired: "Email address is required.",
            couldNotSendResetLink: "Could not send reset link. Please try again.",
            sessionExpiredReset: "Session expired. Please request a new reset link.",
            ...
            emailVerificationFailed: "Email verification failed. Please try signing up again or contact support.",
            verificationLinkInvalid: "Verification link is invalid or has expired. Please try again.",
            noResetCode: "No reset code found. Please request a new password reset link.",
        ...
        enrollment: {
            ...
            personal: {
                ...
                incomeSource: "Job Title / Occupation",
                ...
                household: {
                    ...
                    subtitle: "Add your spouse, children, and other dependants.",
                    ...
                    dob: "Date of Birth",
                    relationship: "Relationship",
                    isDependent: "Tax dependant",
                    livesWithPrimary: "Lives with primary filer",
                    relationships: {
                        SPOUSE: "Spouse",
        ...
        documents: {
            title: "My Documents",
            subtitle: "Upload your tax slips, receipts, and supporting documents.",
            enrollmentSubtitle: "Upload your slips (T4, T5, receipts, etc.) now or later from your dashboard. This step is optional.",
            uploadBtn: "Upload Files",
            dragDrop: "Drag & drop your files here, or click to browse",
            labelPlaceholder: "Description (e.g. T4 from employer)",
            labelLabel: "Description (optional)",
            errorSize: "This file exceeds the 15 MB limit.",
            errorType: "File type not accepted. PDF, JPEG, PNG, HEIC, Excel, or CSV only.",
            errorUpload: "Upload failed. Please try again.",
            successUpload: "File(s) uploaded successfully!",
            noDocuments: "No documents uploaded yet.",
            uploadedAt: "Uploaded on",
            maxFiles: "Maximum 10 files per upload.",
            uploading: "Uploading…",
            deleteConfirm: "Delete this document?",
            deleteBtn: "Delete",
            notifyAdmin: "The administrator will be notified of your new documents.",
            selectedFiles: "file(s) selected",
            submitUpload: "Send Files",
            remove: "Remove",
            optional: "This step is optional — you can upload documents at any time from your dashboard.",
